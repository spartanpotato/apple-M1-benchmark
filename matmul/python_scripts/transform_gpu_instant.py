...
input_file = f'./outputs/csvs/gpu_instant_{precision}bits.csv'  # Replace with your actual input file
output_file = f'./outputs/csvs/gpu_instant_transformed_{precision}bits.csv'  # Replace with your desired output file
